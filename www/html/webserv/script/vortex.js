...
function blackhole(element) {
    ...
    var star = function() {
        ...
        this.speed = (Math.floor(Math.random() * .4) + .3) * Math.PI / 180; // The rate at which this star will orbit
        ...
        this.collapseBonus = this.orbital - (maxorbit * .5); // This "bonus" is used to randomly place some stars outside of the blackhole on hover
        ...
        this.expansePos = centery + (maxorbit / 2) + this.collapseBonus; // Where the star will go on hover of the blackhole
        this.yOrigin = centery + (this.id % 100) * -10 + (Math.floor(Math.random() * 1000) + 500); // Where the star will go when expansion takes place
